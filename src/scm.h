...
SCM_API string_char scm_char_value(ptr x);
...
#define scm_vector_length(x) ((iptr)((uptr)(*((iptr *)((uptr)(x) + 1))) >> 3))
#define scm_vector_ref(x, i) (((ptr *)((uptr)(x) + 5))[i])
#define scm_fxvector_length(x) ((iptr)((uptr)(*((iptr *)((uptr)(x) + 1))) >> 4))
#define scm_fxvector_ref(x, i) (((ptr *)((uptr)(x) + 5))[i])

#define scm_string_length(x) ((iptr)((uptr)(*((iptr *)((uptr)(x) + 1))) >> 4))
#define scm_string_ref(x, i) scm_char_value(((string_char *)((uptr)(x) + 5))[i])
...
#define scm_void ((ptr)0x3E)
#define scm_eof_object ((ptr)0x36)
#define scm_vector_length(x) ((iptr)((uptr)(*((iptr *)((uptr)(x) + 1))) >> 4))
#define scm_vector_ref(x, i) (((ptr *)((uptr)(x) + 9))[i])

#define scm_fxvector_length(x) ((iptr)((uptr)(*((iptr *)((uptr)(x) + 1))) >> 4))
#define scm_fxvector_ref(x, i) (((ptr *)((uptr)(x) + 9))[i])
#define scm_string_length(x) ((iptr)((uptr)(*((iptr *)((uptr)(x) + 1))) >> 4))
#define scm_string_ref(x, i) scm_char_value(((string_char *)((uptr)(x) + 9))[i])
...
SCM_API ptr scm_call5_proc(ptr proc, ptr arg0, ptr arg1, ptr arg2, ptr arg3,
                           ptr arg4);
